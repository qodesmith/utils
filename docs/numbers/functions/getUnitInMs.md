[@qodestack/utils](../../README.md) / [numbers](../README.md) / getUnitInMs

# Function: getUnitInMs()

> **getUnitInMs**(`quantity`, `unit`, `isLeapYear?`): `number`

Defined in: [numbers.ts:147](https://github.com/qodesmith/utils/blob/454dfeeb7b8c144bcc13726c63d1753237871405/src/numbers.ts#L147)
